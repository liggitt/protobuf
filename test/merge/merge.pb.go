...
type D struct {
	E                    CustomSizedType   `protobuf:"varint,1,opt,name=e,proto3,casttype=CustomSizedType" json:"e,omitempty"`
	F                    CustomUnsizedType `protobuf:"varint,2,opt,name=f,proto3,casttype=CustomUnsizedType" json:"f,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *D) GetF() CustomUnsizedType {
	if m != nil {
		return m.F
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*D)(nil), "merge.D")
}
...
var fileDescriptor_82caea6f5430298b = []byte{
	...
	0x62, 0x39, 0x71, 0x4f, 0x9e, 0x21, 0x88, 0x31, 0x09, 0x24, 0x9b, 0x2c, 0xc1, 0xa4, 0xc0, 0x8c,
	0x24, 0xeb, 0x0c, 0x93, 0x4d, 0x56, 0x12, 0xe4, 0x62, 0x74, 0x12, 0xe2, 0x01, 0x29, 0x01, 0x19,
	0xc0, 0x0c, 0x15, 0x72, 0x06, 0x09, 0xa5, 0xc0, 0x84, 0x52, 0x94, 0xbc, 0xb9, 0x18, 0x5d, 0x84,
	0x14, 0xb9, 0x18, 0x53, 0x21, 0x42, 0x4e, 0xc2, 0xbf, 0xee, 0xc9, 0xf3, 0x3b, 0x97, 0x16, 0x97,
	0xe4, 0xe7, 0x06, 0x67, 0x56, 0xa5, 0xa6, 0x84, 0x54, 0x16, 0xa4, 0x06, 0x31, 0xa6, 0x0a, 0x29,
	0x73, 0x31, 0xa6, 0x49, 0x30, 0x81, 0x95, 0x88, 0xfe, 0xba, 0x27, 0x2f, 0x08, 0x51, 0x12, 0x9a,
	0x57, 0x8c, 0x50, 0x94, 0x96, 0xc4, 0x06, 0x76, 0xba, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x10,
	0x26, 0x9d, 0x3a, 0xff, 0x00, 0x00, 0x00,
}
